...
import { SalesData, SalesSubSection, Language, UserProfile, TranslationKey, SalesSectionHelp } from '../../types';
  ...
  const renderContent = () => {
    switch(activeSubSection) {
      case SalesSubSection.GO_TO_MARKET:
        return <GoToMarketArchitect salesData={initialData} onUpdateData={onUpdateData} t={t} language={language} />;
      case SalesSubSection.CRM_PIPELINE:
        return <CrmPipelinePage salesData={initialData} onUpdateData={onUpdateData} t={t} language={language} />;
      default:
