...
export const translations: Record<Language, Partial<LocalizedContent>> = {
  en: {
    ...
    personas_sidebar_title: "Your Personas",
    personas_create_new_button: "Create New Persona",
    personas_welcome_title: "Define Your Target Audience",
    personas_welcome_message: "Create detailed personas to better understand your customers' needs, motivations, and pain points. Click 'Create New Persona' to start.",
    personas_edit_persona_title: "Edit Persona",
    'persona_name_label': "Name",
    'persona_name_placeholder': "e.g., Abebe, Fatuma",
    'persona_profession_label': "Profession",
    'persona_profession_placeholder': "e.g., Farmer, Restaurant Owner",
    ...
    'persona_age_placeholder': "e.g., 35",
    'persona_location_label': "Location",
    'persona_location_placeholder': "e.g., Addis Ababa, Bole",
    ...
    'persona_education_label': "Education",
    ...
    'persona_bio_label': "Bio",
    'persona_bio_placeholder': "A short summary of the persona's background and story.",
    ...
    'traits_technical': "Technical",
    'traits_social_media': "Social Media Savvy",
    'traits_self_helping': "Self-Helping",
    ...
    'persona_likes_placeholder': "What do they like or what are their hobbies?",
    'persona_dislikes_label': "Dislikes",
    'persona_dislikes_placeholder': "What do they dislike?",
    'persona_frustrations_label': "Frustrations & Pain Points",
    'persona_frustrations_placeholder': "What are their biggest frustrations that your product can solve?",
    'persona_skills_label': "Skills",
    'persona_skills_placeholder': "What relevant skills do they have?",
    'persona_jobs_to_be_done_title': "Jobs To Be Done",
    'jtbd_add_new_button': "Add Job",
    'jtbd_edit_button': "Edit Job",
    'jtbd_no_jobs_placeholder': "No 'Jobs To Be Done' defined yet. Click 'Add Job' to create one.",
    ...
    'jtbd_situation_prompt': "WHEN I...",
    'jtbd_situation_placeholder': "am in a specific context or situation...",
    'jtbd_motivation_label': "Motivation",
    'jtbd_motivation_prompt': "I WANT TO...",
    'jtbd_motivation_placeholder': "achieve a certain goal or outcome...",
    'jtbd_outcome_label': "Outcome",
    'jtbd_outcome_prompt': "SO I CAN...",
    'jtbd_outcome_placeholder': "get the expected result or benefit.",
    'jtbd_emotional_job_label': "Emotional Job",
    'jtbd_emotional_job_prompt': "MAKING ME FEEL...",
    'jtbd_emotional_job_placeholder': "confident, relieved, excited...",
    'jtbd_social_job_label': "Social Job",
    'jtbd_social_job_prompt': "OTHERS SEE I'M...",
    'jtbd_social_job_placeholder': "innovative, efficient, a good provider...",
    'add_button': "Add",
    'export_personas_button': "Export Personas",
    'export_all_personas_button': 'Export All Personas',
    'personas_help_button_tooltip': 'How Personas Work',
    'personas_ai_generate_button_tooltip': 'Generate Persona with AI',
    'ai_persona_modal_title': 'AI Persona Generator',
    'ai_persona_idea_label': 'Describe your ideal customer in a few words:',
    'ai_persona_idea_placeholder': 'e.g., A young, tech-savvy coffee shop owner in Addis Ababa.',
    'ai_persona_q1_label': '1. What is the main problem this persona faces that your business solves?',
    'ai_persona_q1_placeholder': 'e.g., They struggle to find reliable, high-quality coffee bean suppliers.',
    'ai_persona_q2_label': '2. Describe their typical day or a key challenge in their work.',
    'ai_persona_q2_placeholder': 'e.g., Manages staff, handles inventory, and is always looking for ways to attract more customers.',
    'ai_persona_q3_label': '3. How do they discover new products/services for their business?',
    'ai_persona_q3_placeholder': 'e.g., Through social media like Instagram, recommendations from other business owners, and local trade magazines.',
    'ai_persona_generate_button': 'Generate Persona',
    'ai_persona_generating_button': 'Generating...',
    'personas_help_modal_title': 'Customer Persona Guide',
    'pdf_persona_report_title': 'Customer Persona Report',
    'pdf_persona_demographics_title': 'Demographics',
    'pdf_persona_bio_title': 'Biography',
    'pdf_persona_personality_title': 'Personality Profile',
    'pdf_persona_traits_title': 'Behavioral Traits',
    ...
    'personas_help_intro': "A persona is a semi-fictional character based on your current or ideal customer. Creating personas helps you understand your users' needs, experiences, behaviors, and goals. It allows you to design better products and services by seeing the world from your customer's perspective.",
    'personas_help_name_title': 'Name & Profession',
    'personas_help_name_desc': "Give your persona a realistic name and job title. This makes them more memorable and relatable.",
    'personas_help_demographics_title': 'Demographics',
    'personas_help_demographics_desc': "Basic details like age, gender, location, marital status, and education provide a quick snapshot of who this person is. For location, be specific to the Ethiopian context (e.g., 'Addis Ababa, Bole' not just 'Ethiopia').",
    'personas_help_bio_title': 'Bio',
    'personas_help_bio_desc': "Write a short story about your persona. What's their background? What are they like? This brings the persona to life.",
    'personas_help_personality_title': 'Personality Sliders',
    'personas_help_personality_desc': "These sliders help you define their character. Are they more analytical or creative? Busy or have lots of free time? This influences how they might interact with your product.",
    'personas_help_traits_title': 'Behavioral Traits Sliders',
    'personas_help_traits_desc': "These sliders define their behavior. Do they have the authority to make purchases? Are they tech-savvy? How much do they rely on social media? This helps you understand how to market and sell to them.",
    'personas_help_goals_title': 'Goals & Motivations',
    'personas_help_goals_desc': "What is the persona trying to achieve? What are their likes and dislikes? What skills do they have? This helps you understand what drives them.",
    'personas_help_frustrations_title': 'Frustrations & Pain Points',
    'personas_help_frustrations_desc': "This is the most critical part for product development. What problems are they facing that your business can solve? Be specific.",
    'personas_help_jtbd_title': 'Jobs To Be Done (JTBD)',
    'personas_help_jtbd_desc': "This framework helps you understand the 'job' a customer hires a product to do. It's a powerful way to get to the core motivation behind a purchase. Fill out each part to get a deep insight into their needs.",
  ...
  am: {
    ...
    'personas_page_title': "የደንበኛ ዓይነቶች",
    'personas_sidebar_title': "የእርስዎ የደንበኛ ዓይነቶች",
    'personas_create_new_button': "አዲስ የደንበኛ ዓይነት ፍጠር",
    'personas_welcome_title': "ዒላማ ታዳሚዎችዎን ይግለጹ",
    'personas_welcome_message': "የደንበኞችዎን ፍላጎቶች፣ ተነሳሽነቶች እና የችግር ነጥቦችን በተሻለ ለመረዳት ዝርዝር የደንበኛ ዓይነቶችን ይፍጠሩ። ለመጀመር 'አዲስ የደንበኛ ዓይነት ፍጠር' የሚለውን ይጫኑ።",
    'personas_edit_persona_title': "የደንበኛ ዓይነት አስተካክል",
    'persona_name_label': "ስም",
    'persona_name_placeholder': "ለምሳሌ፦ አበበ፣ ፋጡማ",
    'persona_profession_label': "ሙያ",
    'persona_profession_placeholder': "ለምሳሌ፦ ገበሬ፣ የምግብ ቤት ባለቤት",
    'persona_gender_label': "ፆታ",
    'persona_gender_male': "ወንድ",
    'persona_gender_female': "ሴት",
    'persona_gender_other': "ሌላ",
    'persona_gender_select': "ፆታ ይምረጡ",
    'persona_age_label': "ዕድሜ",
    'persona_age_placeholder': "ለምሳሌ፦ 35",
    'persona_location_label': "አካባቢ",
    'persona_location_placeholder': "ለምሳሌ፦ አዲስ አበባ፣ ቦሌ",
    'persona_marital_status_label': "የጋብቻ ሁኔታ",
    'persona_marital_status_single': "ያላገባ/ች",
    ...
    'persona_bio_label': "የህይወት ታሪክ",
    'persona_bio_placeholder': "ስለ ደንበኛው ዳራ እና ታሪክ አጭር ማጠቃለያ።",
    'persona_personality_title': "ስብዕና",
    'personality_analytical': "ተንታኝ",
    'personality_creative': "ፈጣሪ",
    'personality_busy': "ሥራ የሚበዛበት/ባት",
    'personality_time_rich': "ጊዜ ያለው/ያላት",
    'personality_messy': "የተዝረከረከ",
    'personality_organized': "የተደራጀ",
    'personality_independent': "በራሱ/ሷ የሚተማመን",
    'personality_team_player': "የቡድን ተጫዋች",
    'persona_traits_title': "ባህሪያት",
    'traits_buying_authority': "የመግዛት ስልጣን",
    'traits_technical': "ቴክኒካል",
    'traits_social_media': "የማህበራዊ ሚዲያ አዋቂ",
    'traits_self_helping': "ራሱን/ሷን የሚረዳ",
    'persona_goals_label': "ግቦች",
    'persona_goals_placeholder': "ከምርትዎ/አገልግሎትዎ ጋር የተያያዙ ዋና ግቦቻቸው ምንድን ናቸው?",
    'persona_likes_label': "የሚወዷቸው ነገሮች",
    'persona_likes_placeholder': "ምን ይወዳሉ ወይም የትርፍ ጊዜ ማሳለፊያዎቻቸው ምንድን ናቸው?",
    'persona_dislikes_label': "የማይወዷቸው ነገሮች",
    'persona_dislikes_placeholder': "ምን ይጠላሉ?",
    'persona_frustrations_label': "ብስጭቶች እና የችግር ነጥቦች",
    'persona_frustrations_placeholder': "ምርትዎ ሊፈታቸው የሚችላቸው ትልልቅ ብስጭቶቻቸው ምንድን ናቸው?",
    'persona_skills_label': "ክህሎቶች",
    'persona_skills_placeholder': "ምን ዓይነት ተዛማጅ ክህሎቶች አሏቸው?",
    'persona_jobs_to_be_done_title': "ሊሰሩ የሚገባቸው ስራዎች",
    'jtbd_add_new_button': "ስራ ጨምር",
    'jtbd_edit_button': "ስራ አስተካክል",
    'jtbd_no_jobs_placeholder': "እስካሁን 'ሊሰሩ የሚገባቸው ስራዎች' አልተገለጹም። አንዱን ለመፍጠር 'ስራ ጨምር' የሚለውን ይጫኑ።",
    ...
    'jtbd_situation_prompt': "እኔ... ጊዜ",
    'jtbd_situation_placeholder': "በተወሰነ አውድ ወይም ሁኔታ ውስጥ ስሆን...",
    'jtbd_motivation_label': "ተነሳሽነት",
    'jtbd_motivation_prompt': "እኔ... እፈልጋለሁ",
    'jtbd_motivation_placeholder': "የተወሰነ ግብ ወይም ውጤት ለማግኘት...",
    'jtbd_outcome_label': "ውጤት",
    'jtbd_outcome_prompt': "ስለዚህ... እችላለሁ",
    'jtbd_outcome_placeholder': "የሚጠበቀውን ውጤት ወይም ጥቅም ለማግኘት።",
    'jtbd_emotional_job_label': "ስሜታዊ ስራ",
    'jtbd_emotional_job_prompt': "ይህ... እንዲሰማኝ ያደርጋል",
    'jtbd_emotional_job_placeholder': "በራስ መተማመን፣ እፎይታ፣ መጓጓት...",
    'jtbd_social_job_label': "ማህበራዊ ስራ",
    'jtbd_social_job_prompt': "ሌሎች እኔን... እንደሆንኩ ያዩኛል",
    'jtbd_social_job_placeholder': "ፈጠራ ያለው፣ ቀልጣፋ፣ ጥሩ አስተዳዳሪ...",
    'add_button': "ጨ.",
    'export_personas_button': "የደንበኛ ዓይነቶችን ላክ",
    'export_all_personas_button': 'ሁሉንም የደንበኛ ዓይነቶች ላክ',
    'personas_help_button_tooltip': 'የደንበኛ ዓይነቶች እንዴት እንደሚሰሩ',
    'personas_ai_generate_button_tooltip': 'በ AI የደንበኛ ዓይነት ፍጠር',
    'ai_persona_modal_title': 'AI የደንበኛ ዓይነት አመንጪ',
    'ai_persona_idea_label': 'የእርስዎን ተመራጭ ደንበኛ በጥቂት ቃላት ይግለጹ:',
    'ai_persona_idea_placeholder': 'ለምሳሌ፦ በአዲስ አበባ የምትገኝ ወጣት፣ ቴክኖሎጂ የምትወድ የቡና ቤት ባለቤት።',
    'ai_persona_q1_label': '1. ይህ የደንበኛ ዓይነት የሚያጋጥመውና የእርስዎ ንግድ የሚፈታው ዋነኛ ችግር ምንድን ነው?',
    'ai_persona_q1_placeholder': 'ለምሳሌ፦ አስተማማኝና ጥራት ያለው የቡና ፍሬ አቅራቢዎችን ለማግኘት ይቸገራሉ።',
    'ai_persona_q2_label': '2. የዕለት ተዕለት ህይወታቸውን ወይም በሥራቸው ውስጥ ያለ ቁልፍ ተግዳሮትን ይግለጹ።',
    'ai_persona_q2_placeholder': 'ለምሳሌ፦ ሰራተኞችን ያስተዳድራል፣ ዕቃዎችን ይቆጣጠራል፣ እና ሁልጊዜ ተጨማሪ ደንበኞችን ለመሳብ መንገዶችን ይፈልጋል።',
    'ai_persona_q3_label': '3. ለንግዳቸው አዲስ ምርቶችን/አገልግሎቶችን እንዴት ያገኛሉ?',
    'ai_persona_q3_placeholder': 'ለምሳሌ፦ እንደ ኢንስታግራም ባሉ ማህበራዊ ሚዲያዎች፣ ከሌሎች የንግድ ባለቤቶች በሚሰጡ ምክሮች፣ እና በአገር ውስጥ የንግድ መጽሔቶች።',
    'ai_persona_generate_button': 'የደንበኛ ዓይነት ፍጠር',
    'ai_persona_generating_button': 'እየተፈጠረ ነው...',
    'personas_help_modal_title': 'የደንበኛ ዓይነት መመሪያ',
    'pdf_persona_report_title': 'የደንበኛ ዓይነት ሪፖርት',
    'pdf_persona_demographics_title': 'የሕዝብ አሰፋፈር መረጃ',
    'pdf_persona_bio_title': 'የሕይወት ታሪክ',
    'pdf_persona_personality_title': 'የስብዕና መገለጫ',
    'pdf_persona_traits_title': 'የባህሪ ዝንባሌዎች',
    'pdf_persona_goals_title': 'ግቦች',
    'pdf_persona_frustrations_title': 'ብስጭቶች እና የችግር ነጥቦች',
    'pdf_persona_jtbd_title': 'ሊሰሩ የሚገባቸው ስራዎች',
    'personas_help_intro': 'የደንበኛ ዓይነት (Persona) አሁን ባለዎት ወይም ሊኖርዎት በሚፈልጉት ደንበኛ ላይ የተመሰረተ ከፊል-ልብ ወለድ ገጸ-ባህሪ ነው። የደንበኛ ዓይነቶችን መፍጠር የተጠቃሚዎችዎን ፍላጎቶች፣ ልምዶች፣ ባህሪዎች እና ግቦች ለመረዳት ይረዳዎታል። ይህም ዓለምን ከደንበኛዎ እይታ በማየት የተሻሉ ምርቶችን እና አገልግሎቶችን እንዲቀርጹ ያስችልዎታል።',
    'personas_help_name_title': 'ስም እና ሙያ',
    'personas_help_name_desc': 'ለደንበኛዎ ዓይነት እውነተኛ የሚመስል ስም እና የስራ መደብ ይስጡ። ይህ የበለጠ እንዲታወስ እና እንዲቀረብ ያደርገዋል።',
    'personas_help_demographics_title': 'የሕዝብ አሰፋፈር መረጃ',
    'personas_help_demographics_desc': 'እንደ ዕድሜ፣ ፆታ፣ አካባቢ፣ የጋብቻ ሁኔታ እና ትምህርት ያሉ መሰረታዊ ዝርዝሮች ይህ ሰው ማን እንደሆነ ፈጣን መረጃ ይሰጣሉ። ለአካባቢ፣ የኢትዮጵያን አውድ ይጠቀሙ (ለምሳሌ፦ ‘አዲስ አበባ、 ቦሌ’ እንጂ ‘ኢትዮጵያ’ ብቻ አይደለም)።',
    'personas_help_bio_title': 'የሕይወት ታሪክ',
    'personas_help_bio_desc': 'ስለ ደንበኛዎ ዓይነት አጭር ታሪክ ይጻፉ። ዳራቸው ምንድን ነው? ምን ይመስላሉ? ይህ የደንበኛውን ዓይነት ህያው ያደርገዋል።',
    'personas_help_personality_title': 'የስብዕና ማንሸራተቻዎች',
    'personas_help_personality_desc': 'እነዚህ ማንሸራተቻዎች ባህሪያቸውን ለመወሰን ይረዱዎታል። የበለጠ ተንታኝ ናቸው ወይስ ፈጣሪ? ስራ ይበዛባቸዋል ወይስ ብዙ ነፃ ጊዜ አላቸው? ይህ ከምርትዎ ጋር እንዴት ሊገናኙ እንደሚችሉ ላይ ተጽዕኖ ያሳድራል።',
    'personas_help_traits_title': 'የባህሪ ዝንባሌ ማንሸራተቻዎች',
    'personas_help_traits_desc': 'እነዚህ ማንሸራተቻዎች ባህሪያቸውን ይወስናሉ። የመግዛት ስልጣን አላቸው? በቴክኖሎጂ የተካኑ ናቸው? በማህበራዊ ሚዲያ ላይ ምን ያህል ይተማመናሉ? ይህ እንዴት ለነሱ ገበያ መፍጠር እና መሸጥ እንደሚችሉ ለመረዳት ይረዳዎታል።',
    'personas_help_goals_title': 'ግቦች እና ተነሳሽነቶች',
    'personas_help_goals_desc': 'የደንበኛው ዓይነት ምን ለማሳካት እየሞከረ ነው? የሚወዱት እና የማይወዱት ምንድን ነው? ምን ክህሎቶች አሏቸው? ይህ እነሱን የሚያነሳሳቸውን ለመረዳት ይረዳዎታል።',
    'personas_help_frustrations_title': 'ብስጭቶች እና የችግር ነጥቦች',
    'personas_help_frustrations_desc': 'ይህ ለምርት ልማት በጣም ወሳኙ ክፍል ነው። የእርስዎ ንግድ ሊፈታቸው የሚችላቸው ምን ችግሮች እያጋጠሟቸው ነው? የተወሰነ ይሁኑ።',
    'personas_help_jtbd_title': 'ሊሰሩ የሚገባቸው ስራዎች (JTBD)',
    'personas_help_jtbd_desc': 'ይህ ማዕቀፍ አንድ ደንበኛ አንድን ምርት ‘ለመቅጠር’ ያለውን ‘ስራ’ ለመረዳት ይረዳዎታል። ይህ የግዢ ጀርባ ያለውን ዋና ተነሳሽነት ለማወቅ ኃይለኛ መንገድ ነው። የእነሱን ፍላጎቶች በጥልቀት ለመረዳት እያንዳንዱን ክፍል ይሙሉ።',
