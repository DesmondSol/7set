...
export const translations: Record<Language, Partial<LocalizedContent>> = {
  ...
  am: {
    ...
    q_sk2_text: "በסטาร์ትአፕ አውድ ውስጥ 'መዞር' (pivoting) የሚለውን ጽንሰ-ሀሳብ ምን ያህል ይገነዘባሉ (1 = በፍጹም፣ 5 = በጣም 잘)?",
    q_sk3_text: "በኢትዮጵያ ውስጥ ለסטาร์ትአፕዎ የመጀመሪያ የመነሻ ካፒታል በዋናነት የትኛውን የገንዘብ ምንጭ ኢላማ ያደርጋሉ?",
    ...
    q_sk5_text: "ለኢትዮጵያ סטาร์ትአፕ መስራች ቡድንዎን ሲገነቡ በጣም አስፈላጊው ነገር ምንድነው?",
