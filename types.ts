...
export type TranslationKey =
  ...
  | 'q_p4_text'
  | 'q_p4_opt_not_at_all' | 'q_p4_opt_slightly' | 'q_p4_opt_moderately' | 'q_p4_opt_very' | 'q_p4_opt_extremely'
  ...
  | 'q_ba3_text'
  | 'q_ba3_opt_very_uncomfortable' | 'q_ba3_opt_uncomfortable' | 'q_ba3_opt_neutral' | 'q_ba3_opt_comfortable' | 'q_ba3_opt_very_comfortable'
  ...
  | 'q_sk2_text'
  | 'q_sk2_opt_not_at_all' | 'q_sk2_opt_slightly' | 'q_sk2_opt_moderately' | 'q_sk2_opt_very' | 'q_sk2_opt_expert'
